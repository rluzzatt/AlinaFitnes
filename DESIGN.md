...
- **Contact controls:** rectangular anchors with a directional or WhatsApp SVG icon. Conversion wording is לשיעור ניסיון throughout; service-card exploration wording remains unchanged. The final invitation is מתחילים בשיעור אחד with the user's casual, no-commitment trial copy. All WhatsApp URLs go directly to `https://wa.me/972532831333`, with no prefilled text. Telephone links use `tel:+972532831333`.
