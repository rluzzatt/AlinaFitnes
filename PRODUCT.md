...
- The user then requested photo enhancement and supplied two additional studio-tour videos. After seeing that first pass, they supplied phone screenshots rejecting the overlapping service-mode composition and requested stronger AI photo work. Current images use five `*-editorial.webp` derivatives, including the restored training frame; source JPEGs and first-pass `*-enhanced.webp` files remain available. Each hero mode now has a distinct image and unclipped text block. The videos are `assets/videos/studio-space-tour.mp4` (24 seconds) and `studio-equipment-tour.mp4` (12 seconds), both placed in the strength section. Preserve the user's real environment and identity when editing media.
